...
public class User extends BaseEntity {
	...
	public String toString() {
		return "User [id=" + this.id + ", gravatarId=" + this.gravatarId + ", login=" + this.login + ", name=" + this.name + ", email=" + this.email + ", location=" + this.location + ", fullname=" + this.fullname + ", username=" + this.username + ", blog=" + this.blog + ", company=" + this.company + ", followingCount=" + this.followingCount + ", followersCount=" + this.followersCount + ", publicGistCount=" + this.publicGistCount + ", publicRepoCount=" + this.publicRepoCount + ", totalPrivateRepoCount=" + this.totalPrivateRepoCount + ", collaborators=" + this.collaborators + ", diskUsage=" + this.diskUsage + ", ownedPrivateRepoCount=" + this.ownedPrivateRepoCount + ", privateGistCount=" + this.privateGistCount + ", createdAt=" + this.createdAt + ", score=" + this.score + "]";
	}
